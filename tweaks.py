...
def update_beedle_text(self):
  ...
  lines = msg.string.split("\n")
  lines[4] = "You should try to save up \\{1A 06 FF 00 00 01}" + str(silver_membership_points) + " points\\{1A 06 FF 00 00 00}, so you\n"
  msg = self.bmg.messages_by_id[3920]
  lines = msg.string.split("\n")
  lines[0] = "OHHHHH! You saved up \\{1A 06 FF 00 00 01}" + str(silver_membership_points) + " points\\{1A 06 FF 00 00 00}!"
  msg = self.bmg.messages_by_id[3922]
  lines = msg.string.split("\n")
  lines[5] = "\\{1A 06 FF 00 00 01}" + str(gold_membership_points) + " points\\{1A 06 FF 00 00 00} to earn our Gold Membership!"
  msg = self.bmg.messages_by_id[3923]
  lines = msg.string.split("\n")
  lines[0] = "OHHHHH! You've saved up \\{1A 06 FF 00 00 01}" + str(gold_membership_points) + " points\\{1A 06 FF 00 00 00}!"
  msg = self.bmg.messages_by_id[3958]
  lines = msg.string.split("\n")
  lines[8] = " Since you have earned " + str(gold_membership_points) + " points, you have\n"
  msg = self.bmg.messages_by_id[3959]
  lines = msg.string.split("\n")
  lines[9] = " earned " + str(gold_membership_points) + " shopping points. This entitles\n"
